      ...
      <div ref={mobileNav}>
        ...
        >
          <ul className="px-5 py-2">
            {/*<li>*/}
            {/*  <Link href="/about" className="flex text-gray-600 hover:text-gray-900 py-2" onClick={() => setMobileNavOpen(false)}>About</Link>*/}
            {/*</li>*/}
            {/*<li>*/}
            ...
            <li>
              <Link
                href="/login"
                className="flex text-sm font-medium w-full text-gray-600 hover:text-gray-900 py-2 justify-center"
