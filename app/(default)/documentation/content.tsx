    ...
    <div className="md:grow">
      <div className="text-lg text-gray-600">
        ...
        <p className="flex items-center text-base px-3 py-4 text-gray-800 bg-blue-100 border border-blue-200 rounded mb-8">
          ...
          >
            <path
              d="M8 0a8 8 0 100 16A8 8 0 008 0zm2.629 11.618L8 10.236l-2.629 1.382.5-2.927-2.124-2.073 2.939-.427L8 3.528l1.314 2.663 2.939.427-2.126 2.073.502 2.927z"
              fill="#338CF5"
              fillRule="nonzero"
            />
          </svg>
      ...
      <div className="mt-8">
        ...
        <a
          className="flex justify-between items-center p-4 rounded border border-gray-200 transition duration-300 ease-in-out bg-white shadow-md hover:shadow-lg mb-4"
          href="#0"
        >
          <div>
            ...
            <div className="text-sm text-gray-600">
              Learn more about orci ac auctor augue mauris augue neque gravida.
            </div>
          </div>
          <svg
            className="w-4 h-4 fill-current text-blue-600 shrink-0 ml-6"
            viewBox="0 0 16 16"
            xmlns="http://www.w3.org/2000/svg"
          >
